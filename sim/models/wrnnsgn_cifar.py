...
# https://github.com/tomgoldstein/loss-landscape/blob/master/cifar10/models/resnet.py
...
wrn8k8                  4,731,018
'''
def wrnnsgn8(num_classes=10):
    '''2+(1+1+1)*2 = 8'''
    return ResNet(BasicBlockNoShortcut, [1, 1, 1], 1, num_classes)

def wrnnsgn8k2(num_classes=10):
    '''2+(1+1+1)*2 = 8'''
    return ResNet(BasicBlockNoShortcut, [1, 1, 1], 2, num_classes)

def wrnnsgn8k4(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [1, 1, 1], 4, num_classes)

def wrnnsgn8k8(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [1, 1, 1], 8, num_classes)

def wrnnsgn8k10(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [1, 1, 1], 10, num_classes)
...
wrn14k8                10,927,754
'''
def wrnnsgn14k2(num_classes=10):
    '''2+(1+1+1)*2 = 8'''
    return ResNet(BasicBlockNoShortcut, [2, 2, 2], 2, num_classes)

def wrnnsgn14k4(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [2, 2, 2], 4, num_classes)

def wrnnsgn14k8(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [2, 2, 2], 8, num_classes)
...
wrn20k8                17,124,490
'''
def wrnnsgn20(num_classes=10):
    '''2+(1+1+1)*2 = 8'''
    return ResNet(BasicBlockNoShortcut, [3, 3, 3], 1, num_classes)

def wrnnsgn20k2(num_classes=10):
    '''2+(1+1+1)*2 = 8'''
    return ResNet(BasicBlockNoShortcut, [3, 3, 3], 2, num_classes)

def wrnnsgn20k4(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [3, 3, 3], 4, num_classes)

def wrnnsgn20k8(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [3, 3, 3], 8, num_classes)
...
wrn10k8                17,124,490
'''
def wrnnsgn10(num_classes=10):
    '''2+(1+1+1+1)*2 = 10'''
    return ResNet(BasicBlockNoShortcut, [1, 1, 1, 1], 1, num_classes)

def wrnnsgn10k2(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [1, 1, 1, 1], 2, num_classes)

def wrnnsgn10k4(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [1, 1, 1, 1], 4, num_classes)

def wrnnsgn10k8(num_classes=10):
    return ResNet(BasicBlockNoShortcut, [1, 1, 1, 1], 8, num_classes)

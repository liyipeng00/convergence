...
wrn14k8                10,927,754
'''
def wrngn14k2(num_classes=10):
    '''2+(1+1+1)*2 = 8'''
    return ResNet(BasicBlock, [2, 2, 2], 2, num_classes)

def wrngn14k4(num_classes=10):
    return ResNet(BasicBlock, [2, 2, 2], 4, num_classes)

def wrngn14k8(num_classes=10):
